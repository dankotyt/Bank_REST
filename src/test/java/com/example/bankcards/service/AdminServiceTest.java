...
class AdminServiceTest {
    ...
    @Test
    void getUserByPhone_WhenUserNotFound_ShouldThrowException() {
    ...
    @Test
    void updateUser_WhenPhoneNumberExists_ShouldThrowException() {
        UpdateUserRequest request = new UpdateUserRequest();
    ...
    void updateUser_ShouldNotUpdateFieldsWhenNull() {
        ...
        originalUser.setPhoneNumber("+1111111111");
