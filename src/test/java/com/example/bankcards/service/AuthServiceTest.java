...
class AuthServiceTest {
    ...
    void register_ShouldReturnTokensWithUserDTO() {
        ...
        when(userRepository.existsByEmailOrPhoneNumber("john@example.com", "+1234567890")).thenReturn(false);
    ...
    void refreshToken_ShouldReturnNewTokensWithUserDTO() {
        ...
        assertThat(result).isEqualTo(expectedResponse);
        assertThat(result.getUserDTO()).isNotNull();
        assertThat(result.getUserDTO().getPhoneNumber()).isEqualTo("+1234567890");
    }
